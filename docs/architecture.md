...
2.  **Load:** JSON is dumped _as-is_ into the Data Lake (S3/MinIO). No transformation happens here.
...
**While Dagster is used locally for its superior developer experience and lineage visualization, we utilize AWS Step Functions in production to maintain a serverless, zero-cost architecture for this batch workload.**
